...
- [PR with SQL injection violation](https://github.com/zariffromlatif/autopatcher-demo-python/pull/1)
...
- [PR with safe parameterized query](https://github.com/zariffromlatif/autopatcher-demo-python/pull/2)
...
- Docs: [ROADMAP.md](./ROADMAP.md) | [RELEASE_NOTES.md](./RELEASE_NOTES.md)
